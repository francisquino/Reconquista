...
Bat::Bat(Graphics &graphics, sf::Vector2i spawnPoint) :
 ...
 void Bat::setupAnimations() {
    this->addAnimation(3, 2, 32, "FlyLeft", 16, 16, sf::Vector2i(0,0));
    this->addAnimation(3, 2, 48, "FlyRight", 16, 16, sf::Vector2i(0,0));
 }
